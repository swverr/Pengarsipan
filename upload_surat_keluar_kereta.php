    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            echo '<script language="javascript">window.history.back();</script>';
                ...
                //validasi input data
                if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $id_surat)){
                    ...
                    echo '<script language="javascript">window.history.back();</script>';
                                    ...
                                    if(!empty($file)){
                                        ...
                                        $query = mysqli_query($config, "UPDATE tbl_surat_keluar SET no_agenda='$no_agenda',file='$nfile',keterangan='Dokumen Sudah Lengkap' WHERE id_surat='$id_surat'");
                                            ...
                                            if($query == true){
                                                ...
                                                header("Location: ./admin.php?page=tskkereta");
                                                die();
                                            //     echo '<script language="javascript">
                                            // window.location.href="./admin.php?page=tskkereta";
                                            //   </script>';
                                            } else {
                        ...
                        $query = mysqli_query($config, "UPDATE tbl_surat_keluar SET keterangan='Dokumen Sudah Lengkap' WHERE id_surat='$id_surat'");
            ...
            if($_SESSION['admin'] != 9){
                ...
                <div class="row jarak-form">
                    ...
                    <!-- Form START -->
                    <form class="col s12" method="POST" action="?page=tskkereta&act=uploadkereta" enctype="multipart/form-data">
