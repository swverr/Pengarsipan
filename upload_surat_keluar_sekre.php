        ...
        if(isset($_REQUEST['submit'])){
                                    ...
                                    if(!empty($file)){
                                        ...
                                        $query = mysqli_query($config, "UPDATE tbl_surat_keluar SET no_agenda='$no_agenda',file='$nfile',keterangan='Dokumen Sudah Lengkap' WHERE id_surat='$id_surat'");
                                            ...
                                            if($query == true){
                                                ...
                                                header("Location: ./admin.php?page=tsksekre");
                                                die();
                                            //     echo '<script language="javascript">
                                            // window.location.href="./admin.php?page=tsksekre";
                                            //   </script>';
                                            } else {
            ...
            if($_SESSION['admin'] != 5){
                ...
                <div class="row jarak-form">
                    ...
                    <!-- Form START -->
                    <form class="col s12" method="POST" action="?page=tsksekre&act=uploadsekre" enctype="multipart/form-data">
